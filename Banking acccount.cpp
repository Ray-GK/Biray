...
//==============================================================================
  class Bank {
        ...
        char openAcc(){
             ...
             gotoxy(31,1); std::cout<<" RACHAEL BANK INC.";
             ...
             gotoxy(18,17); std::cout<<" ACC NO(NUM<=6) : ";
        ...
        void progressBarGraphicz(){
             gotoxy(27,5); std::cout<<"RACHAEL BANK LIMITED EDITION";
        ...
        void aboutUs(){
            ...
            gotoxy(4,6); std::cout<<" RACHAEL BANK INC. WAZ STARTED IN 2010 IN HONOUR OF THE LEGENDARY 2PAC ";
            ...
            gotoxy(4,9); std::cout<<" A BANK AND NAMED IT RACHAEL BANK INCORPORATED. RACHAEL WAZ STARTED ON ";
            gotoxy(4,10); std::cout<<" A PARTICULAR PURPOSE TO SERVE ALL THE NAMAYI OUT THERE LIVING IN THE";
            gotoxy(4,11); std::cout<<" DIASPORA AND FIND IT HARD MAKING IT IN LIFE. RACHAEL BANK INC IS A  ";
            gotoxy(4,12); std::cout<<" PRIVATLEY OWNED COMPANY AND ITS NOT AFFILIATED TO ANY BANK. RACHAEL";
            gotoxy(4,13); std::cout<<" BANK IS SITUATED IN THE RACHAEL TERRITORY BUT SOON GOING GLOBAL.";
            gotoxy(4,14); std::cout<<" RACHAEL BANK INC IS FUNDED BY WELL WISHERZ AND THE PEOPLE IN THE AREA";
...
//==============================================================================
   void depositAmountz(){
        ...
        gotoxy(18,21); std::cout<<"KSHS AMOUNT "<<amt<<" DEPOSITED SUCCESSFULLY!";
        getch();
...
//==============================================================================
   void balanceCheck(){
        ...
        gotoxy(18,17);std::cout<<" WITH RACHAEL BANK INCORPORATED!!";
        getch();
...
//==============================================================================
   void withdrawAmountz(){
        ...
        fseek(inFile,-sizeof(banky), SEEK_CUR);
        fwrite(&banky,sizeof(banky), 1, inFile);
        gotoxy(18,21); std::cout<<"KSHS AMOUNT "<<amt<<" WITHDRAWN SUCCESSFULLY!";
        getch();
...
//==============================================================================
  void bankerMenu(){
       ...
       do {
           ...
           gotoxy(32,3); std::cout<<"RACHAEL BANK INC.";
...
//==============================================================================
   void bankerLogin(void){
        ...
        gotoxy(30,5); std::cout<<"RACHAEL BANK INC.";
...
//==============================================================================
 void adminLogin(void){
      ...
      do{
          ...
          if(adminName=="RACHAEL" && pass=="0715632580"){
          for(j=1;j<=1;j++){
...
//==============================================================================
 void aboutProgrammer(void){
      ...
      gotoxy(30,5); std::cout<<"RACHAEL BANK INC.";
      gotoxy(26,11); std::cout<<"PROGRAMMER: RACHAEL WANGITHI";
      gotoxy(26,13); std::cout<<"EMAIL: wangithirachael@gmail.com";
      gotoxy(33,17); std::cout<<" NOTIFICATION ";
      for(j=1;j<=1;j++){
...
//==============================================================================
  int main(){
      SetConsoleTitle("RACHAEL BANK INC.");
      progressBar();
      }
//==============================================================================
